      ...
      <div className='container flex items-center justify-center min-h-screen px-6 py-12 mx-auto'>
        <div className='w-full '>
          <div className='flex flex-col items-center max-w-lg mx-auto text-center'>
            <p className='text-sm font-medium text-emerald-600'>404 error</p>
            ...
            <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
              <button
                onClick={router.back}
                className='flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border border-gray-700 rounded-lg gap-x-2 sm:w-auto hover:bg-gray-50'
              >
                <TbArrowLeft />
          ...
          <div className='grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3'>
            ...
            <div className='p-6 rounded-lg bg-emerald-50'>
              ...
              <h3 className='mt-6 font-medium text-gray-700'>Chat with us</h3>
