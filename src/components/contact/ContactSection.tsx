            ...
            <address className='flex flex-col items-start justify-center gap-2 py-6 not-italic font-medium text-left'>
              ...
              <div className='flex flex-col gap-4 mt-4'>
                ...
                <div className='inline-flex items-start space-x-2 font-medium'>
                  <HiOutlinePhone className='flex-shrink-0 w-5 h-5 mt-px text-emerald-500' />
                  <div>
                    <a
                      href='tel:+91-8987662772'
                      className='duration-150 hover:text-emerald-600'
                    >
                      +91-8987662772
                    </a>
                    ,{" "}
                ...
                <a
                  className='inline-flex items-center justify-start space-x-2 duration-150 hover:text-emerald-500'
                  href='mailto:webmaster@somedomain.com'
                >
                  <HiOutlineMail className='flex-shrink-0 w-5 h-5 mt-px text-emerald-500' />
            ...
            <div>
              ...
              <div className='mt-1'>
                <input
                  ...
                  className='block w-full px-3 py-3 border border-gray-200 rounded-md shadow-sm sm:text-sm focus:border-emerald-500'
                />
              </div>
            </div>
            <div>
